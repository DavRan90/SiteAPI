...
namespace SiteAPI.Migrations
{
    ...
    [Migration("20250618180630_AddedBoolSiteNotnull")]
    partial class AddedBoolSiteNotnull
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("SiteAPI.Models.Element", b =>
                {
                    ...
                    b.PrimitiveCollection<string>("MenuLinks")
                        .HasColumnType("nvarchar(max)")
                        .HasAnnotation("Relational:JsonPropertyName", "menuLinks");
